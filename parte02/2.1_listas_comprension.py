...
resultado = [n1  for n1 in numeros_1 for n2 in numeros_2 if n1 == n2 and n1 not in interseccion]
print(len(resultado))
print(resultado)

print()
#usamos un conjunto (set) y el otro conjunto (set) para hallar los elementos comunes de dos listas
