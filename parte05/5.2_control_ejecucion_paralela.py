...
def retirar(saldo, lock):
    for i in range(500):
        lock.acquire()      #para adquirir el control sobre la interacción actual
        saldo.value = saldo.value - 1  #value es un objeto de multiprocessing
        lock.release()      # liberar el control sobre la interacción actual
