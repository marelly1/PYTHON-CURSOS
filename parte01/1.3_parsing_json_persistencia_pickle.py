...
edward = {'id': 1001, 'nombre': 'Edward', 'apellido': 'Ortíz', 'especialidad': 'front-end', 'lenguaje': 'JavaScript', 'email': 'edward@mail.co'}
...
with open('parte01/programadores.json', 'w') as f:
    json.dump(datos, f)
#    cuando el ide no muestra ni las tildes y las ñ se adiciona estos códigos
#with open('parte01/programadores.json', 'w',encoding="utf-8") as f:
